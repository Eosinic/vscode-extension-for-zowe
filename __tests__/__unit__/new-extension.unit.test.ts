...
describe("Extension Unit Tests", () => {
    ...
    // it.skip("Testing that createMember correctly executes", async () => {
    ...
    // it.skip("Testing that refreshPS correctly executes with and without error", async () => {
    ...
    // it.skip("Call Change File type", async () => {
    ...
    // it.skip("Test Get Profile", async () => {
    ...
    // describe.skip("Add Session Unit Test", () => {
    ...
    //     it.skip("Testing that addSession will cancel if there is no profile name", async () => {
    ...
    //     it.skip("Testing that addSession with supplied profile name", async () => {
    //         const entered = undefined;
    ...
    //     it.skip("Testing that addSession with existing profile", async () => {
    //         const entered = "";
    //         const addSession = jest.spyOn(extension, "addZoweSession");
    ...
    //     it.skip("Testing that addSession with supplied resolveQuickPickHelper", async () => {
    //         const entered = "fake";
    //         const addSession = jest.spyOn(extension, "addZoweSession");
    ...
    //     it.skip("Testing that addSession with undefined profile", async () => {
    //         const entered = "";
    //         const addSession = jest.spyOn(extension, "addZoweSession");
    ...
    //     it.skip("Testing that addSession if createNewConnection is invalid", async () => {
    //         const entered = "fake";
    //         const addSession = jest.spyOn(extension, "addZoweSession");
    ...
    //     it.skip("Testing that addSession if listProfile is invalid", async () => {
    //         const entered = "fake";
    //         const addSession = jest.spyOn(extension, "addZoweSession");
    ...
    // it.skip("Testing that createFile is executed successfully", async () => {
    ...
    // it.skip("tests the createFile for prompt credentials", async () => {
    //     Object.defineProperty(profileLoader.Profiles, "getInstance", {
    //         value: jest.fn(() => {
    //             return {
    //                 allProfiles: [profileOne, {name: "secondName"}],
    ...
    // it.skip("tests the createFile for prompt credentials, favorite route", async () => {
    //     Object.defineProperty(profileLoader.Profiles, "getInstance", {
    //         value: jest.fn(() => {
    //             return {
    //                 allProfiles: [profileOne, {name: "secondName"}],
    ...
    // it.skip("tests the createFile for prompt credentials error", async () => {
    //     Object.defineProperty(profileLoader.Profiles, "getInstance", {
    //         value: jest.fn(() => {
    //             return {
    //                 allProfiles: [profileOne, {name: "secondName"}],
    ...
    // it.skip("Testing that deleteDataset is executed successfully", async () => {
    //     existsSync.mockReset();
    ...
    // it.skip("Testing that deleteDataset is executed successfully for favorite", async () => {
    //     existsSync.mockReset();
    //     unlinkSync.mockReset();
    //     showQuickPick.mockReset();
    //     const deleteSpy = jest.spyOn(mvsApi, "deleteDataSet");
    ...
    // it.skip("Testing that deleteDataset is executed successfully for pdsf", async () => {
    //     existsSync.mockReset();
    //     unlinkSync.mockReset();
    //     showQuickPick.mockReset();
    //     const deleteSpy = jest.spyOn(mvsApi, "deleteDataSet");
    ...
    // it.skip("Testing that deleteDataset fails if junk passed", async () => {
    //     existsSync.mockReset();
    //     unlinkSync.mockReset();
    //     showQuickPick.mockReset();
    ...
    // it.skip("Testing that enterPattern is executed successfully", async () => {
    //     showInformationMessage.mockReset();
    //     showInputBox.mockReset();
    ...
    // it.skip("Testing that enterPattern is executed successfully for search favorite", async () => {
...
//     it.skip("Testing that openPS is executed successfully", async () => {
//         dataSet.mockReset();
//         openTextDocument.mockReset();
//         showTextDocument.mockReset();
//         showErrorMessage.mockReset();
...
//     it.skip("Testing that that openPS credentials prompt is executed successfully", async () => {
//         showQuickPick.mockReset();
//         showInputBox.mockReset();
//         showTextDocument.mockReset();
//         openTextDocument.mockReset();
...
//     it.skip("Testing that that openPS credentials prompt works with favorites", async () => {
//         showTextDocument.mockReset();
//         openTextDocument.mockReset();
//         showQuickPick.mockReset();
//         showInputBox.mockReset();
...
//     it.skip("Testing that that openPS credentials prompt ends in error", async () => {
//         showTextDocument.mockReset();
//         openTextDocument.mockReset();
//         showQuickPick.mockReset();
//         showInputBox.mockReset();
...
//     it.skip("Testing that that openPS credentials with favorites ends in error", async () => {
//         showTextDocument.mockReset();
//         openTextDocument.mockReset();
//         showQuickPick.mockReset();
//         showInputBox.mockReset();
...
//     describe.skip("refresh USS checking", () => {
...
//         it.skip("refreshUSS works correctly for dirty file state, when user didn't cancel file save", async () => {
...
//         });
//         it.skip("refreshUSS works correctly for dirty file state, when user cancelled file save", async () => {
//             const node = new ZoweUSSNode("test-node", vscode.TreeItemCollapsibleState.None, ussNode, null, "/");
...
//         });
//         it.skip("refreshUSS works correctly for not dirty file state", async () => {
//             const node = new ZoweUSSNode("test-node", vscode.TreeItemCollapsibleState.None, ussNode, null, "/");
...
//             expect(node.downloaded).toBe(true);
//         });
//         it.skip("refreshUSS works correctly with exception thrown in process", async () => {
//             const node = new ZoweUSSNode("test-node", vscode.TreeItemCollapsibleState.None, ussNode, null, "/");
...
//     describe.skip("Add USS Session Unit Test", () => {
//         const qpItem: vscode.QuickPickItem = new utils.FilterDescriptor("\uFF0B " + "Create a new filter");
...
//         it.skip("Testing that addZoweSession will cancel if there is no profile name", async () => {
//             showQuickPick.mockReset();
//             showInputBox.mockReset();
//             showInformationMessage.mockReset();
//             const entered = undefined;
...
//         it.skip("Testing that addZoweSession with supplied profile name", async () => {
//             const entered = undefined;
...
//         it.skip("Testing that addZoweSession with existing profile", async () => {
//             const entered = "";
//             const addZoweSession = jest.spyOn(extension, "addZoweSession");
...
//         it.skip("Testing that addZoweSession with supplied resolveQuickPickHelper", async () => {
//             const entered = "fake";
//             const addZoweSession = jest.spyOn(extension, "addZoweSession");
...
//         it.skip("Testing that addZoweSession with undefined profile", async () => {
//             const entered = "";
//             const addZoweSession = jest.spyOn(extension, "addZoweSession");
...
//         it.skip("Testing that addZoweSession if createNewConnection is invalid", async () => {
//             const entered = "fake";
//             const addZoweSession = jest.spyOn(extension, "addZoweSession");
...
//         it.skip("Testing that addZoweSession if listProfile is invalid", async () => {
//             const entered = "fake";
//             const addZoweSession = jest.spyOn(extension, "addZoweSession");
...
//     });
//   // TODO Node tests
//     it.skip("Testing that open is executed successfully", async () => {
//         ussFile.mockReset();
//         openTextDocument.mockReset();
//         showTextDocument.mockReset();
//         showErrorMessage.mockReset();
...
//     // TODO Node tests
//     it.skip("Tests that openUSS executes successfully with favored files", async () => {
//         ussFile.mockReset();
//         openTextDocument.mockReset();
//         showTextDocument.mockReset();
...
//     // TODO Node tests
//     it.skip("Testing that open is executed successfully when chtag says binary", async () => {
//         ussFile.mockReset();
//         openTextDocument.mockReset();
//         showTextDocument.mockReset();
//         showErrorMessage.mockReset();
...
//         // TODO Node tests
//     it.skip("Testing that that openUSS credentials prompt is executed successfully", async () => {
//         showQuickPick.mockReset();
//         showInputBox.mockReset();
//         showTextDocument.mockReset();
//         openTextDocument.mockReset();
...
//     it.skip("Testing that that openUSS credentials prompt works with favorites", async () => {
//         showTextDocument.mockReset();
//         openTextDocument.mockReset();
//         showQuickPick.mockReset();
//         showInputBox.mockReset();
...
//     it.skip("Testing that that openUSS credentials prompt with favorites ends in error", async () => {
//         showTextDocument.mockReset();
//         openTextDocument.mockReset();
//         showQuickPick.mockReset();
//         showInputBox.mockReset();
...
//     it.skip("Testing that that openUSS credentials prompt ends in error", async () => {
//         showTextDocument.mockReset();
//         openTextDocument.mockReset();
//         showQuickPick.mockReset();
//         showInputBox.mockReset();
...
//     });
    ...
    it.skip("Testing that saveUSSFile is executed successfully", async () => {
        withProgress.mockReset();
    ...
    // describe.skip("Add Jobs Session Unit Test", () => {
    //     const qpItem: vscode.QuickPickItem = new utils.FilterDescriptor("\uFF0B " + "Create a new filter");
    ...
    //     it.skip("tests the refresh Jobs Server for prompt credentials", async () => {
    //         showQuickPick.mockReset();
    //         showInputBox.mockReset();
    ...
    //     it.skip("tests the refresh Jobs Server for prompt credentials, favorites route", async () => {
    //         showQuickPick.mockReset();
    //         showInputBox.mockReset();
    //         const addJobsSession = jest.spyOn(extension, "refreshJobsServer");
    //         Object.defineProperty(profileLoader.Profiles, "getInstance", {
    ...
    //     it.skip("tests the refresh Jobs Server for prompt credentials with favorites that ends in error", async () => {
    //         showQuickPick.mockReset();
    //         showInputBox.mockReset();
    //         const addJobsSession = jest.spyOn(extension, "refreshJobsServer");
    //         Object.defineProperty(profileLoader.Profiles, "getInstance", {
    ...
    //     it.skip("tests the refresh Jobs Server", async () => {
    //         showQuickPick.mockReset();
    //         showInputBox.mockReset();
    //         const addJobsSession = jest.spyOn(extension, "refreshJobsServer");
    //         Object.defineProperty(profileLoader.Profiles, "getInstance", {
    ...
    //     it.skip("tests the refresh Jobs Server with invalid prompt credentials", async () => {
    //         showQuickPick.mockReset();
    //         showInputBox.mockReset();
    //         const addJobsSession = jest.spyOn(extension, "refreshJobsServer");
    //         Object.defineProperty(profileLoader.Profiles, "getInstance", {
    ...
    //     it.skip("Testing that addJobsSession will cancel if there is no profile name", async () => {
    //         const entered = undefined;
    ...
    //     it.skip("Testing that addJobsSession with supplied profile name", async () => {
    //         const entered = undefined;
    ...
    //     it.skip("Testing that addJobsSession with existing profile", async () => {
    //         const entered = "";
    //         const addJobsSession = jest.spyOn(extension, "addZoweSession");
    ...
    //     it.skip("Testing that addJobsSession with supplied resolveQuickPickHelper", async () => {
    //         const entered = "fake";
    //         const addJobsSession = jest.spyOn(extension, "addZoweSession");
    ...
    //     it.skip("Testing that addJobsSession with undefined profile", async () => {
    //         const entered = "";
    //         const addJobsSession = jest.spyOn(extension, "addZoweSession");
    ...
    //     it.skip("Testing that addJobsSession if createNewConnection is invalid", async () => {
    //         const entered = "fake";
    //         const addJobsSession = jest.spyOn(extension, "addZoweSession");
    ...
    //     it.skip("Testing that addJobsSession if listProfile is invalid", async () => {
    //         const entered = "fake";
    //         const addJobsSession = jest.spyOn(extension, "addZoweSession");
    ...
    // it.skip("tests that the prefix is set correctly on the job", async () => {
    //     showInformationMessage.mockReset();
    //     showInputBox.mockReset();
    ...
    // it.skip("tests that the owner is set correctly on the job", async () => {
    //     showInformationMessage.mockReset();
    //     showInputBox.mockReset();
    ...
    // it.skip("tests that the spool content is opened in a new document", async () => {
    //     showTextDocument.mockReset();
    //     openTextDocument.mockReset();
    ...
    // it.skip("tests that the spool content is not opened in a new document", async () => {
    //     Object.defineProperty(profileLoader.Profiles, "getInstance", {
    //         value: jest.fn(() => {
    //             return {
    //                 allProfiles: [{name: "firstName", profile: {user:undefined, password: undefined}}, {name: "secondName"}],
    ...
    // it.skip("tests that the spool content credentials prompt is executed successfully", async () => {
    //     showTextDocument.mockReset();
    //     openTextDocument.mockReset();
    //     const sessionwocred = new imperative.Session({
    //         user: "",
    ...
    // it.skip("tests that the spool content credentials prompt ends in error", async () => {
    //     showTextDocument.mockReset();
    //     openTextDocument.mockReset();
    //     const sessionwocred = new imperative.Session({
    //         user: "",
    ...
    // it.skip("tests that a stop command is issued", async () => {
    //     showInformationMessage.mockReset();
    ...
    // it.skip("tests that a stop command is not issued", async () => {
    //     showInformationMessage.mockReset();
    //     issueSimple.mockReturnValueOnce({commandResponse: "fake response"});
    ...
    // it.skip("tests that a modify command is issued", async () => {
    //     showInformationMessage.mockReset();
    //     showInputBox.mockReset();
    ...
    // it.skip("tests that a modify command is not issued", async () => {
    //     showInformationMessage.mockReset();
    //     showInputBox.mockReset();
    //     showInputBox.mockReturnValue("modify");
    //     issueSimple.mockReturnValueOnce({commandResponse: "fake response"});
    ...
    // it.skip("tests that the spool is downloaded", async () => {
    ...
    // it.skip("tests that the spool is not downloaded", async () => {
    //     const fileUri = {fsPath: "/tmp/foo"};
    //     showOpenDialog.mockReturnValue([fileUri]);
    ...
    // it.skip("tests that the jcl is downloaded", async () => {
    ...
    // it.skip("tests that the jcl is not downloaded", async () => {
    //     getJclForJob.mockReset();
    //     openTextDocument.mockReset();
    //     showTextDocument.mockReset();
    ...
    // it.skip("tests that the jcl is submitted", async () => {
    //     showInformationMessage.mockReset();
    //     createBasicZosmfSession.mockReturnValue(session);
    ...
    // it.skip("tests that a pds member is submitted", async () => {
    //     showErrorMessage.mockReset();
    ...
    // it.skip("Tests that temp folder handles default preference", () => {
    //     mkdirSync.mockReset();
    //     moveSync.mockReset();
    ...
    // it.skip("Tests that temp folder is moved successfully", () => {
    //     mkdirSync.mockReset();
    //     moveSync.mockReset();
    //     existsSync.mockReset();
    //     existsSync.mockReturnValue(true);
    ...
    // it.skip("Tests that temp folder error thrown 1", () => {
    //     mkdirSync.mockReset();
    //     moveSync.mockReset();
    //     existsSync.mockReset();
    //     showErrorMessage.mockReset();
    ...
    // it.skip("Tests that temp folder error thrown 2", () => {
    //     mkdirSync.mockReset();
    //     moveSync.mockReset();
    //     existsSync.mockReset();
    //     showErrorMessage.mockReset();
    ...
    // it.skip("Tests that temp folder does not update on duplicate preference", () => {
    //     mkdirSync.mockReset();
    //     moveSync.mockReset();
    ...
    // it.skip("Tests that moving temp folder does not show error, if already moved by another Instance", () => {
    //     mkdirSync.mockReset();
    //     moveSync.mockReset();
    ...
    // it.skip("Testing that the add Suffix for datasets works", async () => {
    ...
    // it.skip("Tests the showDSAttributes function", async () => {
    //     dataSetList.mockReset();
    ...
    // describe.skip("Renaming Data Sets", () => {
    //     it.skip("Should rename the node", async () => {
    //         showInputBox.mockReset();
    ...
    //     });
    //     it.skip("Should rename a favorited node", async () => {
    //         showInputBox.mockReset();
    //         renameDataSet.mockReset();
    ...
    //         expect(renameDataSet).toHaveBeenLastCalledWith(child.getSession(), "HLQ.TEST.RENAME.NODE", "HLQ.TEST.RENAME.NODE.NEW");
    //     });
    //     it.skip("Should throw an error if zowe.Rename.dataSet throws", async () => {
    //         let error;
    ...
    //     });
    //     it.skip("Should rename the member", async () => {
    //         showInputBox.mockReset();
    //         renameDataSet.mockReset();
    ...
    //     });
    //     it.skip("Should rename a favorited member", async () => {
    //         showInputBox.mockReset();
    //         renameDataSet.mockReset();
    ...
    //         expect(renameDataSetMember).toHaveBeenLastCalledWith(child.getSession(), "HLQ.TEST.RENAME.NODE", "mem1", "mem2");
    //     });
    //     it.skip("Should throw an error if zowe.Rename.dataSetMember throws", async () => {
    //         let error;
    //         const defaultError = new Error("Default error message");
    ...
    //     });
    // });
    // describe.skip("Copying Data Sets", () => {
    //     it.skip("Should copy the label of a node to the clipboard", async () => {
    //         renameDataSet.mockReset();
    ...
    //     });
    //     it.skip("Should copy the label of a favourited node to the clipboard", async () => {
    //         renameDataSet.mockReset();
    ...
    //         expect(clipboard.readText()).toBe(JSON.stringify({ profileName: "sestest", dataSetName: "HLQ.TEST.DELETE.NODE" }));
    //     });
    //     it.skip("Should copy the label of a member to the clipboard", async () => {
    //         renameDataSet.mockReset();
    ...
    //     });
    //     it.skip("Should copy the label of a favourited member to the clipboard", async () => {
    //         renameDataSet.mockReset();
    ...
    //     });
    // });
    // describe.skip("Pasting Data Sets", () => {
    //     it.skip("Should call zowe.Copy.dataSet when pasting to sequential data set", async () => {
    ...
    //         );
    //     });
    //     it.skip("Should throw an error if invalid clipboard data is supplied when pasting to sequential data set", async () => {
    //         let error;
    //         const node = new ZoweDatasetNode("HLQ.TEST.TO.NODE", vscode.TreeItemCollapsibleState.None, sessNode,
    //                                         null, undefined, undefined, profileOne);
    //         node.contextValue = extension.DS_SESSION_CONTEXT;
    ...
    //     });
    //     it.skip("Should not call zowe.Copy.dataSet when pasting to partitioned data set with no member name", async () => {
    ...
    //         expect(copyDataSet.mock.calls.length).toBe(0);
    //     });
    //     it.skip("Should call zowe.Copy.dataSet when pasting to partitioned data set", async () => {
    ...
    //         );
    //     });
    //     it.skip("Should throw an error when pasting to a member that already exists", async () => {
    ...
    //         expect(copyDataSet.mock.calls.length).toBe(0);
    //     });
    //     it.skip("Should call zowe.Copy.dataSet when pasting to a favorited partitioned data set", async () => {
    //         jest.spyOn(mvsApi, "getContents").mockImplementation(() => {
    //             throw Error("Member not found");
    //         });
    //         const copySpy = jest.spyOn(mvsApi, "copyDataSetMember");
    ...
    //     });
    // });
    // describe.skip("Migrate Data Sets", () => {
    //     it.skip("should call HMigrate.hMigrateDataSet on a sequential data set", async () => {
